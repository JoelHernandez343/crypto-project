...
export default function Item({ className, icon, title, active, index, updateList }) {
  ...
  return (
    <li
      className={`${className} ${active ? 'bg-gray-300 text-indigo-900' : 'text-gray-600'} my-2 md:pl-6 h-12 flex items-center hover:bg-indigo-200 cursor-pointer text-sm transition ease-in-out duration-150`}
